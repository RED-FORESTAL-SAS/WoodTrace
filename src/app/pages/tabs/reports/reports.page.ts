...
export class ReportsPage implements OnInit {
  ...
  //   if (passwordValid) {
  //     this.utilsSvc.presentLoading();
  //     this.firebaseSvc.deleteFromCollection('reports', id).then(async (res: any) => {

  //       await this.firebaseSvc.deleteFromStorage(`${currentUser.id}/reports/${id}.pdf`)
  //       await this.firebaseSvc.deleteFromStorage(`${currentUser.id}/reports/${id}.xlsx`)
