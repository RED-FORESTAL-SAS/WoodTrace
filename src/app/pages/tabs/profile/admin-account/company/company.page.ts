...
export class CompanyPage implements OnInit {
  /**
   * @todo Saber cual es el id del usuario logueado
   * Consultar la colección licencias donde idUser === usuario autenticado.
   * De esa icencia, saber cual es el id de la empresa
   * Consultar la colección users donde id === id de la empresa
   */
